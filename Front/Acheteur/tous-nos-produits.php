...
<?php
    ...
    require "head.php";
        ...
        $queryAllItems = mysqli_query($con, "select id_item,name, price , brand,subcategory,category, quantity, description,photo, is_negotiated, is_buying from item,seller where seller.id_seller=item.id_seller and (is_buying =1 or is_negotiated=1)");
?>
...
<div class="vetement_general">
    ...
    <div class="deco_marque_general position-absolute position-absolute top-0 end-0">
        ...
        <p class="texte_style h4 text-uppercase position-absolute top-50 start-50 translate-middle">All our products</p> 
    </div>
