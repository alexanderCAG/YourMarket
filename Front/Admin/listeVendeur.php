        ...
        <div class="listeVendeur_details">
            <div class="navbar_listeVendeur">
                <ul class="navbar_listeVendeur_details detail_style centrer">
                    <li><a href="listeVendeur.php" class="badge text-uppercase bg_blue1 text-light">All our brands <span class="badge bg-light text-dark"><?php echo $total ; ?></span></a> </li>
                    <li><a href="listeVendeurMaison.php" class="text-uppercase">Furniture brands </a> </li>
