        ...
        <div class="listeVendeur_details">
            <div class="navbar_listeVendeur">
                <ul class="navbar_listeVendeur_details detail_style centrer">
                    ...
                    <li><a href="listeVendeurMaison.php" class="text-uppercase">Furniture brand</a></li>
                    <li><a href="listeVendeurVetement.php" class="badge text-uppercase bg_blue1 text-light">clothing brands <span class="badge bg-light text-dark"><?php echo $total ; ?></span></a> </li>
                </ul>
            </div>
        </div>
