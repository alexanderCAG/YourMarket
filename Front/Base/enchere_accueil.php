...
<div class="enchere_liste_total row">
    ...
    <div class="col-3 enchere_liste_payer centrer position-relative">
        ...
        <a type="button" class="btn_envoyer_propose_prix text-uppercase" href="connexion.php" style="font-weight:bold;padding-bottom:20px!important;text-decoration:none;color:white;">Envoyer</a>
