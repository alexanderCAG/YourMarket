        ...
        <form action="../Bdd/register.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row ajout_article_div_body">
                ...
                <div class="col-5 detail_style mt-4">
                    <input type="checkbox" name="achat_direct_ajoutArticle" id="achat_direct_ajoutArticle" value="direct">Achat Direct
                    <input type="checkbox" name="achat_nego_ajoutArticle" id="achat_nego_ajoutArticle" class="inputAchat_ajoutArticle" value="nego">Négociation
                    <input type="checkbox" name="achat_enchere_ajoutArticle" id="achat_enchere_ajoutArticle" class="inputAchat_ajoutArticle" value="bidding">Enchère
                    <br>
